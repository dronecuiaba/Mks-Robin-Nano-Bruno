...
#define Z_STEPPER_AUTO_ALIGN
  ...
  #define Z_STEPPER_ALIGN_ITERATIONS 2    // Number of iterations to apply during alignment
  #define Z_STEPPER_ALIGN_ACC        0.3 // Stop iterating early if the accuracy is better than this
